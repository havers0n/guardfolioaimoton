...
const TaskItem: React.FC<TaskItemProps> = ({ task, highlight }) => {
  ...
  const highlightStyles = highlight 
    ? "shadow-[0_0_20px_rgba(59,130,246,0.5)] border-blue-400 bg-blue-500/20 scale-105" 
    : "";

  return (
    <div className={`flex items-center gap-4 p-4 mb-3 rounded-xl border transition-all duration-300 ${styles.container} ${highlightStyles}`}>
